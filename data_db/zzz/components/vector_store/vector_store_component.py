...
from openai.extensions.context_filter import ContextFilter
...
class VectorStoreComponent:
    ...
    def __init__(self, settings: AppSettings) -> None:
        ...
        match settings.vector_store.database:
            case "chroma":
                try:
                    ...
                    from components.vector_store.batched_chroma import (
                ...
                chroma_client = chromadb.PersistentClient(
                    path=str((settings.paths.persist_dir / "chroma_db").absolute()),
