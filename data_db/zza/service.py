...
class IngestService:
    ...
    def __init__(
        ...
        self.llm_service = llm_component  # 保留注入（即便当前未直接使用）
    ...
    def ingest_bin_data(self, file_name: str, raw_file_data: BinaryIO) -> List[IngestedDoc]:
        ...
        return self._ingest_data(file_name, raw_file_data.read())
        ...
        try:
            ...
            for doc_id, ref_doc_info in ref_docs.items():
                ...
                ingested_docs.append(
                    IngestedDoc(object="ingest.document", doc_id=doc_id, doc_metadata=doc_metadata)
                )
        except ValueError:
